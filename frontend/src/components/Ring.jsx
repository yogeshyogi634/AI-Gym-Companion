    ...
    <div className="flex flex-col items-center gap-1">
      <div className="relative w-[68px] h-[68px]">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          ...
          <span className="text-[8px] uppercase tracking-wider" style={{opacity:"var(--dim)"}}>{unit}</span>
        </div>
      </div>
      <span className="text-[9px] uppercase tracking-[0.15em]" style={{opacity:"var(--dim)"}}>{label}</span>
    </div>
  );
}
